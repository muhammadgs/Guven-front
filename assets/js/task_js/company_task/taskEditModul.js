...
const TaskEditModule = {
    ...
    saveTaskEdit: async function() {
        ...
        try {
            ...
            if (newWorkTypeId) {
                updateData.work_type_id = newWorkTypeId;
            }
            ...
            if (shouldChangeStatus) {
                ...
                if (finalStatus) {
                    console.log(`📌 Status dəyişdirilir: ${oldStatus} → ${finalStatus}`);
                    ...
                    if (statusUpdateResponse && statusUpdateResponse.error) {
                        console.warn('⚠️ Status dəyişdirilə bilmədi');
                    } else {
                        console.log(`✅ Status uğurla ${finalStatus} olaraq dəyişdirildi`);
