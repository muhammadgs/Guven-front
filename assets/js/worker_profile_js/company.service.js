...
class CompaniesService {
    ...
    <div style="background:#fff;border:.5px solid #e5e7eb;border-radius:12px;padding:20px 24px;margin-bottom:14px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px;">
            ...
            <div class="cdp-stat"><div style="font-size:11px;color:#6b7280;margin-bottom:4px;">Əlaqə növü</div><div style="font-size:13px;font-weight:500;color:#111;">${c.is_parent?'İcraçı Şirkət':c.is_child?'Sifarişçi Şirkət':'—'}</div></div>
