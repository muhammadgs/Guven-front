                                ...
                                <div class="notes-rich-editor-card">
                                    <div class="notes-editor-toolbar" aria-label="Mətn formatlama paneli">
                                        <div class="notes-color-control" title="Hərfin rəngi">
                                            <button id="noteTextColorToggle" class="notes-color-toggle" type="button" aria-label="Yazı rəngi panelini aç" aria-expanded="false" aria-controls="noteColorPopover"><i class="fas fa-palette"></i></button>
