...
class ProfileApp {
    ...
    injectProtocolNotesStyles() {
        ...
        style.textContent = `
            ...
            .protocol-lists-grid{display:grid;grid-template-columns:repeat(2,minmax(360px,1fr));gap:22px!important;margin-top:8px!important;align-items:stretch;flex:1}.protocol-list-card,.protocol-modal-card,.protocol-info-card,.protocol-participants-card,.protocol-notes-card{border-radius:32px;background:rgba(255,255,255,.72);border:1px solid rgba(226,232,240,.9);box-shadow:0 18px 48px rgba(15,23,42,.07);backdrop-filter:blur(18px)}.protocol-list-card{min-height:390px;padding:26px!important}.protocol-list-card h3{margin:0 0 18px!important;font-size:28px;font-weight:800;color:#1f2937}.protocol-list-item{width:100%;text-align:left;border-radius:18px;background:rgba(248,250,252,.94);border:1px solid rgba(226,232,240,.8);padding:16px;margin-top:12px;cursor:pointer;transition:all .2s ease}.protocol-list-item:hover{transform:translateY(-2px);box-shadow:0 14px 30px rgba(37,99,235,.12)}.protocol-list-item-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.protocol-list-item-title{font-size:18px;font-weight:800;color:#1f2937}.protocol-list-item-meta{margin-top:6px;font-size:14px;color:#64748b}.protocol-list-item-stats{display:flex;gap:10px;flex-wrap:wrap;margin-top:12px;color:#475569;font-weight:700}.protocol-status-badge,.protocol-participant-status{display:inline-flex;align-items:center;gap:6px;border-radius:999px;padding:6px 10px;font-size:13px;font-weight:700}.protocol-status-badge.completed,.protocol-participant-status.accepted{background:rgba(34,197,94,.12);color:#16a34a}.protocol-status-badge.incomplete,.protocol-participant-status.pending{background:rgba(245,158,11,.14);color:#d97706}.protocol-participant-status.rejected{background:rgba(239,68,68,.12);color:#dc2626}
            ...
            @media (max-width:1000px){.protocol-toolbar{flex-direction:column;gap:18px}.protocol-toolbar-actions{align-items:flex-start}.protocol-lists-grid{grid-template-columns:1fr}}
