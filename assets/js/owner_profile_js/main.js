...
class ProfileApp {
                        ...
                        <div id="protocolListView" class="protocol-page-view hidden">
                            ...
                            <div class="protocol-lists-grid">
                                ...
                                <div class="protocol-list-card">
                                    ...
                                    <div id="incompleteProtocolsList" class="protocol-list-scroll incomplete-protocols-list"></div>
                                </div>
                            </div>
                        </div>
    ...
    injectProtocolNotesStyles() {
        ...
        style.textContent = `
            ...
            .protocol-notes-page.employees-like-layout{position:relative;isolation:isolate;overflow:hidden!important;height:100%;max-height:100%;min-height:0;display:flex;flex-direction:column;box-sizing:border-box;padding:24px 28px 26px!important;border-radius:36px;background:radial-gradient(circle at 12% 2%,rgba(255,255,255,.94),transparent 30%),radial-gradient(circle at 92% 0%,rgba(67,136,255,.14),transparent 26%),linear-gradient(145deg,rgba(247,247,247,.76),rgba(221,228,238,.62));border:1px solid rgba(255,255,255,.68);box-shadow:inset 0 2px 1px rgba(255,255,255,.82),inset 0 -20px 50px rgba(255,255,255,.3),0 0 0 9px rgba(255,255,255,.14),0 28px 78px rgba(15,23,42,.15);backdrop-filter:blur(26px) saturate(165%)}
