...
class ProfileApp {
                    ...
                    <div class="protocol-notes-page employees-like-layout">
                        ...
                        <div id="createProtocolModal" class="protocol-modal protocol-create-modal hidden">
                            <div class="protocol-modal-card">
                                ...
                                <div class="protocol-form-group"><label>Tarix</label><div style="position: relative; display: flex; align-items: center;"><i class="fas fa-calendar-alt" style="position: absolute; left: 16px; color: #64748b;"></i><input id="protocolCreateDate" type="text" readonly style="padding-left: 42px;" /></div></div>
                                <div style="display: flex; gap: 15px; width: 100%;">
                                    <div class="protocol-form-group" style="flex: 1;"><label>Kateqoriya</label><div style="position: relative; display: flex; align-items: center;"><i class="fas fa-layer-group" style="position: absolute; left: 16px; color: #64748b; pointer-events: none; z-index: 1;"></i><select id="protocolCategorySelect" class="protocol-company-select" style="width: 100%; border-radius: 18px; border: 1px solid rgba(203,213,225,.8); padding: 14px 16px 14px 42px; font-family: inherit; font-size: 16px; outline: none; box-sizing: border-box; background: #fff; appearance: none; cursor: pointer;"><option value="current">Cari şirkət</option><option value="parent">İcraçı Şirkətlər</option><option value="child">Sifarişçi Şirkətlər</option><option value="partner">Partnyorlar</option></select><i class="fas fa-chevron-down" style="position: absolute; right: 16px; font-size: 12px; color: #6b7280; pointer-events: none; z-index: 1;"></i></div></div>
                                    <div class="protocol-form-group" id="protocolSubCompanyGroup" style="display: block; opacity: 0.5; pointer-events: none; flex: 1; transition: opacity 0.2s;"><label>Şirkət</label><div style="position: relative;"><div id="protocolCustomCompanySelect" class="protocol-company-select" style="cursor: pointer; display: flex; justify-content: space-between; align-items: center; background: #fff; width: 100%; border-radius: 18px; border: 1px solid rgba(203,213,225,.8); padding: 14px 16px 14px 16px; font-family: inherit; font-size: 16px; outline: none; box-sizing: border-box;"><div style="display: flex; align-items: center; gap: 10px; overflow: hidden;"><i class="fas fa-building" style="color: #64748b; font-size: 15px;"></i><span id="protocolCustomCompanySelectText" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Şirkət seçin...</span></div><i class="fas fa-chevron-down" style="font-size: 12px; color: #6b7280;"></i></div><div id="protocolCustomCompanyDropdown" style="display: none; position: absolute; top: 100%; left: 0; right: 0; background: #fff; border: 1px solid #e5e7eb; border-radius: 18px; margin-top: 6px; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.1); z-index: 1000; padding: 12px; overflow: hidden;"><div style="position: relative; display: flex; align-items: center; margin-bottom: 8px;"><i class="fas fa-search" style="position: absolute; left: 14px; color: #64748b;"></i><input type="text" id="protocolCompanySearch" placeholder="Şirkət axtar..." style="width: 100%; padding: 12px 14px 12px 38px; border: 1px solid #e5e7eb; border-radius: 12px; font-size: 14px; outline: none; box-sizing: border-box; background: #f8fafc;" /></div><div id="protocolCompanyList" style="max-height: 160px; overflow-y: auto;"></div></div></div><input type="hidden" id="protocolCompanySelect" value="" /></div>
                                </div>
                                <div class="protocol-form-group"><label>Protokolun başlığı</label><div style="position: relative; display: flex; align-items: center;"><i class="fas fa-heading" style="position: absolute; left: 16px; color: #64748b;"></i><input id="protocolTitleInput" type="text" placeholder="Protokolun başlığını yazın..." required style="padding-left: 42px;" /></div></div>
                                <div style="display: flex; gap: 15px; width: 100%;">
                                    <div class="protocol-form-group" style="flex: 1;"><label>Əməkdaşlar</label><div style="position: relative;"><div id="protocolCustomEmployeeSelect" class="protocol-company-select" style="cursor: pointer; display: flex; justify-content: space-between; align-items: center; background: #fff; width: 100%; border-radius: 18px; border: 1px solid rgba(203,213,225,.8); padding: 14px 16px 14px 16px; font-family: inherit; font-size: 16px; outline: none; box-sizing: border-box;"><div style="display: flex; align-items: center; gap: 10px; overflow: hidden;"><i class="fas fa-users" style="color: #64748b; font-size: 15px;"></i><span id="protocolCustomEmployeeSelectText" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">Əməkdaş seçin...</span></div><i class="fas fa-chevron-down" style="font-size: 12px; color: #6b7280;"></i></div><div id="protocolCustomEmployeeDropdown" style="display: none; position: absolute; top: 100%; left: 0; right: 0; background: #fff; border: 1px solid #e5e7eb; border-radius: 18px; margin-top: 6px; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.1); z-index: 1000; padding: 12px; overflow: hidden;"><div style="position: relative; display: flex; align-items: center; margin-bottom: 8px;"><i class="fas fa-search" style="position: absolute; left: 14px; color: #64748b;"></i><input type="text" id="protocolEmployeeSearch" placeholder="Əməkdaş axtar..." style="width: 100%; padding: 12px 14px 12px 38px; border: 1px solid #e5e7eb; border-radius: 12px; font-size: 14px; outline: none; box-sizing: border-box; background: #f8fafc;" /></div><div id="protocolEmployeeSelectList" style="max-height: 160px; overflow-y: auto;"></div></div></div></div>
                                    <div class="protocol-form-group" style="flex: 1;"><label>Əlavə edilmiş əməkdaşlar</label><div id="protocolAddedEmployeesList" style="border: 1px solid rgba(203,213,225,.8); border-radius: 18px; padding: 12px; min-height: 52px; max-height: 200px; overflow-y: auto; background: #fff; display: flex; flex-direction: column; gap: 8px;"><div class="protocol-empty-state" style="color: #94a3b8; font-size: 13px; padding: 4px; text-align: center;">Heç bir əməkdaş seçilməyib</div></div></div>
                                </div>
    ...
    async getProtocolEmployees(customCompanyCode = null) {
        ...
        const findEmbeddedEmployees = (companyList) => {
            if (!companyList || !Array.isArray(companyList)) return null;
            const comp = companyList.find(c => (c.child_company_code || c.parent_company_code || c.target_company_code || c.partner_company_code || c.requester_company_code || c.company_code || c.code || c.id) == companyCode);
            if (comp && (comp.employees || comp.users || comp.workers || comp.staff || comp.company_employees)) {
                return comp.employees || comp.users || comp.workers || comp.staff || comp.company_employees;
            }
            return null;
        };

        const embeddedFromSub = findEmbeddedEmployees(this.protocolCachedSubCompanies);
        if (embeddedFromSub && embeddedFromSub.length > 0) {
            list = embeddedFromSub;
            console.log(`✅ Sub-company içindən ${list.length} işçi tapıldı`);
        }

        if (list.length === 0) {
            const embeddedFromParent = findEmbeddedEmployees(this.protocolCachedParentCompanies);
            if (embeddedFromParent && embeddedFromParent.length > 0) {
                list = embeddedFromParent;
                console.log(`✅ Parent-company içindən ${list.length} işçi tapıldı`);
            }
        }

        if (list.length === 0) {
            const embeddedFromPartner = findEmbeddedEmployees(this.protocolCachedPartnerCompanies);
            if (embeddedFromPartner && embeddedFromPartner.length > 0) {
                list = embeddedFromPartner;
                console.log(`✅ Partner-company içindən ${list.length} işçi tapıldı`);
            }
        }
        ...
        try {
            ...
            if (this.selectedSavedNote?.id) {
                await api.share(this.selectedSavedNote.id, {
                    note_id: Number(this.selectedSavedNote.id),   // ✅ ƏLAVƏ EDİN
                ...
                if (noteId && !(Array.isArray(createdNote?.shared_with) && createdNote.shared_with.length)) {
                    await api.share(noteId, {
                        note_id: Number(noteId),                     // ✅ ƏLAVƏ EDİN
                        shared_to: [Number(selectedId)],             // ✅ number-ə çevirin
                        permissions: { can_edit: false, can_comment: true, can_share: false }
                    });
                }
            ...
            if (window.notificationsService) {
                const title = document.getElementById('noteEditorTitle')?.value || 'Yeni Qeyd';
                window.notificationsService.addNotification({
                    type: 'note',
                    title: title,
                    message: `Sizə yeni qeyd göndərildi.`,
                    date: new Date()
                });
            }
        } catch (error) {
    ...
    async loadAllNotesLists() {
        ...
        const currentUserId = this.currentUserId || 'guest';
        const storageKey = `protocol_read_notes_${currentUserId}`;
        const readNotesStr = localStorage.getItem(storageKey) || '[]';
        let readNotes = [];
        ...
        const attachListEvents = (container, notesList, type) => {
            ...
            const markAsReadUi = (noteId) => {
                ...
                if (!readNotes.includes(String(noteId))) {
                    ...
                    localStorage.setItem(storageKey, JSON.stringify(readNotes));
                }
            };
    ...
    async openCreateProtocolModal() {
        ...
        try {
            ...
            this.protocolSelectedEmployeeObjects = new Map();
            this.currentProtocolId = null; 
            ...
            const categorySelect = document.getElementById('protocolCategorySelect');
            const companySelect = document.getElementById('protocolCompanySelect');
            const subCompanyGroup = document.getElementById('protocolSubCompanyGroup');
            ...
            if (currentCode) {
                try {
                    const protocolService = this.getProtocolService?.() || this.api;
                    const subPromise = window.getSubCompaniesWithCache ? window.getSubCompaniesWithCache(currentCode) : protocolService.get(`/companies/${currentCode}/sub-companies`).then(r => r?.sub_companies || r?.data || []);
                    const parentPromise = protocolService.get(`/companies/${currentCode}/parent-companies`).then(r => r?.parent_companies || r?.data || []);
                    const partnerPromise = protocolService.get(`/partners/?company_code=${currentCode}`).then(r => r?.items || r?.data || []);
                    
                    const [subRes, parentRes, partnerRes] = await Promise.allSettled([subPromise, parentPromise, partnerPromise]);
                    
                    if (subRes.status === 'fulfilled') {
                        subCompanies = subRes.value || [];
                        this.protocolCachedSubCompanies = subCompanies;
                    }
                    if (parentRes.status === 'fulfilled') {
                        parentCompanies = parentRes.value || [];
                        this.protocolCachedParentCompanies = parentCompanies;
                    }
                    if (partnerRes.status === 'fulfilled') {
                        partnerCompanies = partnerRes.value || [];
                        this.protocolCachedPartnerCompanies = partnerCompanies;
                    }
                } catch (e) {
                    console.warn('Şirkətlər yüklənə bilmədi', e);
                }
            }

            const loadEmployeesForCode = async (code) => {
                this.protocolEmployeesCache = [];
                this.protocolSelectedEmployees = new Set();
                this.renderProtocolEmployeeSelectList('Əməkdaşlar yüklənir...');
                try {
                    this.protocolEmployeesCache = await this.getProtocolEmployees(code);
            ...
            if (categorySelect && companySelect && subCompanyGroup) {
                categorySelect.value = 'current';
                subCompanyGroup.style.display = 'block';
                subCompanyGroup.style.opacity = '0.5';
                subCompanyGroup.style.pointerEvents = 'none';
                companySelect.value = '';
                const initCustomSelectText = document.getElementById('protocolCustomCompanySelectText');
                if (initCustomSelectText) initCustomSelectText.innerText = 'Şirkət seçin...';
                
                let currentOptions = [];
                const searchInputComp = document.getElementById('protocolCompanySearch');
                const customSelectText = document.getElementById('protocolCustomCompanySelectText');
                const customSelectTrigger = document.getElementById('protocolCustomCompanySelect');
                const customDropdown = document.getElementById('protocolCustomCompanyDropdown');
                const companyList = document.getElementById('protocolCompanyList');

                if (customSelectTrigger) {
                    customSelectTrigger.onclick = () => {
                        if (customDropdown) {
                            const isHidden = customDropdown.style.display === 'none';
                            customDropdown.style.display = isHidden ? 'block' : 'none';
                            if (isHidden && searchInputComp) {
                ...
                const customEmpTrigger = document.getElementById('protocolCustomEmployeeSelect');
                const customEmpDropdown = document.getElementById('protocolCustomEmployeeDropdown');
                const empSearchInput = document.getElementById('protocolEmployeeSearch');

                if (customEmpTrigger) {
                    customEmpTrigger.onclick = (e) => {
                        if (customEmpDropdown) {
                            const isHidden = customEmpDropdown.style.display === 'none';
                            customEmpDropdown.style.display = isHidden ? 'block' : 'none';
                            if (isHidden && empSearchInput) {
                ...
                const outsideClickListener = (e) => {
                    if (customDropdown && customDropdown.style.display === 'block' && !customDropdown.contains(e.target) && customSelectTrigger && !customSelectTrigger.contains(e.target)) {
                        customDropdown.style.display = 'none';
                    }
                    if (customEmpDropdown && customEmpDropdown.style.display === 'block' && !customEmpDropdown.contains(e.target) && customEmpTrigger && !customEmpTrigger.contains(e.target)) {
                        customEmpDropdown.style.display = 'none';
                    }
                };
                document.removeEventListener('click', outsideClickListener);
                document.addEventListener('click', outsideClickListener);

                const renderCompanyOptions = (filter = '') => {
                    if (!companyList) return;
                    let optsHTML = `<div class="protocol-company-option" data-value="" style="padding: 8px; cursor: pointer; border-radius: 4px; font-size: 13px;">Şirkət seçin...</div>`;
                    const filtered = currentOptions.filter(o => (o.name || '').toLowerCase().includes(filter.toLowerCase()));
                    optsHTML += filtered.map(o => `<div class="protocol-company-option" data-value="${o.code}" style="padding: 8px; cursor: pointer; border-radius: 4px; font-size: 13px;">${o.name}</div>`).join('');
                    companyList.innerHTML = optsHTML;

                    companyList.querySelectorAll('.protocol-company-option').forEach(el => {
                        el.onmouseenter = () => { el.style.backgroundColor = '#f3f4f6'; };
                        el.onmouseleave = () => { el.style.backgroundColor = 'transparent'; };
                        el.onclick = () => {
                            if (customSelectText) customSelectText.innerText = el.innerText;
                            if (companySelect) {
                                companySelect.value = el.getAttribute('data-value');
                                if (companySelect.onchange) companySelect.onchange();
                            }
                ...
                if (searchInputComp) {
                    searchInputComp.oninput = (e) => renderCompanyOptions(e.target.value);
                }
                ...
                categorySelect.onchange = () => {
                    ...
                    if (cat === 'current') {
                        subCompanyGroup.style.opacity = '0.5';
                        subCompanyGroup.style.pointerEvents = 'none';
                        if (customSelectText) customSelectText.innerText = 'Şirkət seçin...';
                        if (companySelect) companySelect.value = '';
                        loadEmployeesForCode(currentCode);
                    } else {
                        subCompanyGroup.style.opacity = '1';
                        subCompanyGroup.style.pointerEvents = 'auto';
                        let list = [];
                        if (cat === 'parent') list = parentCompanies;
                        if (cat === 'child') list = subCompanies;
                        if (cat === 'partner') list = partnerCompanies;
                        
                        currentOptions = list.map(c => {
                            let code = c.company_code || c.code;
                            let name = c.company_name || c.name;
                            
                            if (cat === 'parent') {
                                code = c.parent_company_code || code;
                                name = c.company_name || name;
                            } else if (cat === 'child') {
                                code = c.child_company_code || c.company_code || code;
                                name = c.company_name || c.child_company_name || name;
                            } else if (cat === 'partner') {
                                code = (c.requester_company_code === currentCode) ? c.target_company_code : (c.requester_company_code || c.partner_company_code || c.target_company_code);
                                name = c.partner_company_name || c.target_company_name || c.requester_company_name || name;
                            }
                            
                            code = code || c.id || '';
                            name = name || code || 'Bilinməyən Şirkət';
                            return { code, name };
                        });
                        
                        if (customSelectText) customSelectText.innerText = 'Şirkət seçin...';
                        if (companySelect) companySelect.value = '';
                        if (searchInputComp) searchInputComp.value = '';
                        renderCompanyOptions();
                        
                        this.protocolEmployeesCache = [];
                        this.renderProtocolEmployeeSelectList('Şirkət seçin...');
                    }
                };
                ...
                companySelect.onchange = () => {
                    ...
                    if (selectedCode) {
                        loadEmployeesForCode(selectedCode);
                    } else {
                        this.protocolEmployeesCache = [];
                        this.renderProtocolEmployeeSelectList('Şirkət seçin...');
                    }
    ...
    renderProtocolEmployeeSelectList(message = '') {
        ...
        list.innerHTML = employees.length ? employees.map(emp => `<label class="protocol-employee-select-row" style="display: flex; align-items: center; justify-content: space-between; padding: 6px 8px; cursor: pointer; border-radius: 6px; transition: background 0.2s; margin-bottom: 2px;" onmouseover="this.style.background='#f1f5f9'" onmouseout="this.style.background='transparent'"><span style="display: flex; align-items: center; gap: 8px;"><span style="width: 28px; height: 28px; background: #e2e8f0; color: #1e293b; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 600; flex-shrink: 0;">${this.escapeProtocolHtml(emp.fullName.charAt(0).toUpperCase())}</span><span style="display: flex; flex-direction: column;"><strong style="font-size: 13px; font-weight: 500; color: #334155;">${this.escapeProtocolHtml(emp.fullName)}</strong><small style="font-size: 11px; color: #64748b;">${this.escapeProtocolHtml(emp.department || 'Şöbə qeyd edilməyib')}</small></span></span><input class="protocol-employee-checkbox" type="checkbox" value="${this.escapeProtocolHtml(emp.id)}" ${this.protocolSelectedEmployees.has(String(emp.id)) ? 'checked' : ''} style="width: 16px; height: 16px; cursor: pointer; border-radius: 4px; border: 1px solid #cbd5e1; flex-shrink: 0; margin: 0;"></label>`).join('') : '<div class="protocol-empty-state" style="padding: 12px; font-size: 13px; text-align: center; color: #94a3b8;">Əməkdaş tapılmadı.</div>';
        
        list.querySelectorAll('.protocol-employee-checkbox').forEach(input => input.addEventListener('change', () => {
            const empId = String(input.value);
            if (input.checked) {
                this.protocolSelectedEmployees.add(empId);
                const empObj = employees.find(e => String(e.id) === empId);
                if (empObj) this.protocolSelectedEmployeeObjects.set(empId, empObj);
            } else {
                this.protocolSelectedEmployees.delete(empId);
                this.protocolSelectedEmployeeObjects.delete(empId);
            }
            this.renderProtocolAddedEmployeesList();
            
            const selText = document.getElementById('protocolCustomEmployeeSelectText');
            if (selText) {
                selText.innerText = this.protocolSelectedEmployees.size > 0 
                    ? `${this.protocolSelectedEmployees.size} əməkdaş seçildi` 
                    : 'Əməkdaş seçin...';
            }
        }));
    }
    
    renderProtocolAddedEmployeesList() {
        const list = document.getElementById('protocolAddedEmployeesList');
        if (!list) return;
        
        if (!this.protocolSelectedEmployeeObjects || this.protocolSelectedEmployeeObjects.size === 0) {
            list.innerHTML = '<div class="protocol-empty-state" style="color: #94a3b8; font-size: 13px; padding: 4px; text-align: center;">Heç bir əməkdaş seçilməyib</div>';
            return;
        }
        
        let html = '';
        this.protocolSelectedEmployeeObjects.forEach(emp => {
            html += `
                <div style="display: flex; justify-content: space-between; align-items: center; background: #f1f5f9; padding: 8px 12px; border-radius: 8px; border: 1px solid #e2e8f0;">
                    <div style="display: flex; align-items: center; gap: 8px; overflow: hidden;">
                        <span class="protocol-participant-avatar protocol-employee-avatar" style="width: 28px; height: 28px; font-size: 12px; flex-shrink: 0;">${this.escapeProtocolHtml(emp.fullName.charAt(0).toUpperCase())}</span>
                        <div style="display: flex; flex-direction: column; overflow: hidden;">
                            <span style="font-size: 13px; font-weight: 600; color: #1e293b; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${this.escapeProtocolHtml(emp.fullName)}</span>
                            <span style="font-size: 11px; color: #64748b; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${this.escapeProtocolHtml(emp.department || 'Şöbə qeyd edilməyib')}</span>
                        </div>
                    </div>
                    <button type="button" class="protocol-remove-added-emp" data-id="${emp.id}" style="background: none; border: none; color: #ef4444; cursor: pointer; padding: 4px; display: flex; align-items: center; justify-content: center; border-radius: 4px; flex-shrink: 0;">
        ...
        list.querySelectorAll('.protocol-remove-added-emp').forEach(btn => {
            btn.onclick = () => {
                const empId = String(btn.getAttribute('data-id'));
                this.protocolSelectedEmployees.delete(empId);
                this.protocolSelectedEmployeeObjects.delete(empId);
                this.renderProtocolAddedEmployeesList();
                this.renderProtocolEmployeeSelectList(); // update checkboxes
    ...
    async createProtocolFromModal() {
        ...
        const compName = document.getElementById('protocolCustomCompanySelectText')?.innerText;
        ...
        try {
            ...
            if (window.notificationsService) {
                selected.forEach(emp => {
                    window.notificationsService.addNotification({
                        type: 'personal',
                        title: 'Yeni Protokol: ' + protocol.title,
                        message: `${emp.fullName} üçün yeni protokol təyin olundu.`,
                        date: new Date()
                    });
                });
            }
    ...
    async addEmployeeToCurrentProtocol(employeeId) {
        ...
        try {
            ...
            if (window.notificationsService) {
                const p = this.getProtocolById(this.currentProtocolId);
                window.notificationsService.addNotification({
                    type: 'personal',
                    title: 'Yeni Protokol: ' + (p ? p.title : ''),
                    message: `${employee.fullName} protokola əlavə edildi.`,
                    date: new Date()
                });
            }
