                        ...
                        <div id="protocolDetailView" class="protocol-page-view protocol-detail-view hidden">
                            ...
                            <div class="protocol-main-grid">
                                <div class="protocol-participants-card">
                                    <div class="protocol-card-header protocol-section-title-row"><div class="protocol-section-title-icon"><i class="fas fa-users"></i></div><div><h3>Əməkdaşların siyahısı</h3><p>Seçilmiş iştirakçılar</p></div></div>
